...

{
  ...
  {
    send(remoteMethod.ARC, radius, angle, immediateReturn);
  }
 ...
 /**
  ...
  {
    send(remoteMethod.TRAVEL, distance, 0, immediateReturn);
  }
...
public void rotate(float angle, boolean immediateReturn)
  {
    send(remoteMethod.ROTATE ,angle,0,immediateReturn);
  }
...
/**
 ...
 public void rotate(float angle)
  ...
  {
    send(remoteMethod.STEER, turnRate, angle, immediateReturn);
  }
...
/**
 ...
 /**
  ...
  public void forward()
  {
    send(remoteMethod.FORWARD,0,0,false);
  }
  ...
  {
    send(remoteMethod.BACKWARD,0,0,false);
  }

  public void setMoveSpeed(float speed)
  {
    send(remoteMethod.SETMOVESPEED, speed, 0, false);
  }

  public void setTurnSpeed(float speed)
  {
    send(remoteMethod.SETTURNSPEED, speed, 0, false);
  }
  ...
  public void reset()
  {
    send(remoteMethod.RESET, 0, 0, false);
  }
  ...
  public void stop()
  {
    send(remoteMethod.STOP, 0, 0, false);
  }
...
private void report()
  {
    send(remoteMethod.REPORT, 0, 0, false);
  }
/**
